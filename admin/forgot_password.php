                ...
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100" method="get" action="index.html">
                    <div class="input-material-group mb-3">
                      ...
                      <label class="label-material" for="login-username">Staff ID</label>
                    </div>
                    <div class="input-material-group mb-3">
                      <input class="input-material" id="login-username" type="text" name="loginUsername" autocomplete="off" required data-validate-field="loginUsername">
                      <label class="label-material" for="login-username">Staff email</label>
                    </div>
                    ...
                    <input class="btn btn-primary mb-3" id="" name="submit" type="submit" value="Update" style="color: #ffffff;">
                    <br>
                    <!-- <a class="text-sm text-paleBlue" href="update_password.php">Forgot Password?</a><br> -->
                    <!-- <small class="text-gray-500"> Go back </small> -->
                    <a class="text-sm text-paleBlue" href="login.php">Go back</a>
                  </form>
                </div>
              </div>
            </div>
