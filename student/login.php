  ...
  <body>
            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-6">
                <div class="info d-flex justify-content-center flex-column p-4 h-100">
                  <div class="py-5">
                    <h1 class="display-6 fw-bold"> <span style="font-size: 18px;">Student Login</span> <strong><br> Dashboard</strong></h1>
                ...
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100" method="POST" >
                    ...
                    <div class="input-material-group mb-3">
                      <input class="input-material" id="" type="text" name="student_id" required >
                      <label class="label-material" for="">Student ID Number</label>
                    </div>
    ...
    <?php 
      ...
      if(isset($_POST['login'])) {
        $count = 0;
        $res = mysqli_query($db, "SELECT * FROM `student_table` 
        WHERE student_id='$_POST[student_id]' && password='$_POST[password]'");
        ...
        <?php 
          ...
          $_SESSION['login_user'] = $_POST['student_id'];
          ?>
              <script type="text/javascript">
